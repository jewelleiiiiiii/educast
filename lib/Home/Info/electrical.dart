...
class Electrical extends StatefulWidget {
  @override
  _Electrical createState() => _Electrical();
}

class _Electrical extends State<Electrical> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Electrical Engineering Technology').get();
      if (doc.exists) {
        lessonData['1'] =
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BElecET')
                                : (index == 1
                                ? const Text('Why Choose BElecET?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BElecET')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BElecET')
                                : const Text('')))),
                            children: [
                              Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Top Jobs for BElecET Graduates:",
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
