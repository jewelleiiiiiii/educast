...
class HumssInfo extends StatefulWidget {
  @override
  _HumssInfo createState() => _HumssInfo();
}

class _HumssInfo extends State<HumssInfo> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('strandcontent').doc('humss').get();
      if (doc.exists) {
                      ...
                      return Card(
                        ...
                        child: ExpansionTile(
                          ...
                          title: index == 0
                              ...
                              : (index == 2
                              ? const Text('Career Opportunities in HUMSS')
                              : (index == 3
                              ? const Text('Skills Developed in HUMSS')
                              : const Text('')))),
                          children: [
                            Column(
