...
class Criminology extends StatefulWidget {
  @override
  _Criminology createState() => _Criminology();
}

class _Criminology extends State<Criminology> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Science in Criminology').get();
      if (doc.exists) {
        lessonData['1'] =
      ...
      Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/criminology.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BSCrim')
                                : (index == 1
                                ? const Text('Why Choose BSCrim?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BSCrim')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BSCrim')
                                : const Text('')))),
                            children: [
                              Column(
