...
class _Food extends State<Food> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Food Engineering Technology').get();
      if (doc.exists) {
        lessonData['1'] =
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BFET')
                                : (index == 1
                                ? const Text('Why Choose BFET?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BFET')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BFET')
                                : const Text('')))),
                            children: [
                              Column(
