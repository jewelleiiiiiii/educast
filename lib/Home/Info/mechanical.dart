...
class Mechanical extends StatefulWidget {
  @override
  _Mechanical createState() => _Mechanical();
}

class _Mechanical extends State<Mechanical> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Mechanical Engineering Technology').get();
      if (doc.exists) {
        lessonData['1'] =
      ...
      Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/Mechanical.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BMechET')
                                : (index == 1
                                ? const Text('Why Choose BMechET?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BMechET')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BMechET')
                                : const Text('')))),
                            children: [
                              Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Top Jobs for BMechET Graduates:",
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
