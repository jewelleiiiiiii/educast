...
class Psychology extends StatefulWidget {
  @override
  _Psychology createState() => _Psychology();
}

class _Psychology extends State<Psychology> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Science in Psychology').get();
      if (doc.exists) {
        lessonData['1'] =
      ...
      Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/Psychology.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BSPsych')
                                : (index == 1
                                ? const Text('Why Choose BSPsych?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BSPsych')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BSPsych')
                                : const Text('')))),
                            children: [
                              Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Top Jobs for BSPsych Graduates:",
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
