...
class Mechatronics extends StatefulWidget {
  @override
  _Mechatronics createState() => _Mechatronics();
}

class _Mechatronics extends State<Mechatronics> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Mechatronics Engineering Technology').get();
      if (doc.exists) {
        lessonData['1'] =
      ...
      Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image: AssetImage('assets/Mechatronics.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: Stack(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BMechtronET')
                                : (index == 1
                                ? const Text('Why Choose BMechtronET?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BMechtronET')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BMechtronET')
                                : const Text('')))),
                            children: [
                              Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Top Jobs for BMechtronET Graduates:",
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
