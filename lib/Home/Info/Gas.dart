...
class AcademicGasScreen extends StatelessWidget {
  const AcademicGasScreen({super.key});
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          const Padding(
                                            ...
                                            child: Text(
                                              'GAS offers a versatile educational foundation for students who want '
                                                  'to explore a broad range of subjects and fields. It provides a '
                                                  'well-rounded curriculum that integrates elements of humanities, '
                                                  'social sciences, and general studies, preparing students for various '
                                                  'college programs and career paths. GAS encourages critical thinking, '
                                                  'effective communication, and a deep understanding of societal issues, '
                                                  'making it an ideal choice for those seeking a flexible academic experience.',
                                              style: TextStyle(
                                                fontSize: 14,
