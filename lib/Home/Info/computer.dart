...
class Computer extends StatefulWidget {
  @override
  _Computer createState() => _Computer();
}
...
class _Computer extends State<Computer> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Computer Engineering Technology').get();
      if (doc.exists) {
        lessonData['1'] =
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BCompET')
                                : (index == 1
                                ? const Text('Why Choose BCompET?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BCompET')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BCompET')
                                : const Text('')))),
                            children: [
                              Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Top Jobs for BCompET Graduates:",
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
