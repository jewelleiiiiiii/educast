...
class _Electronics extends State<Electronics> {
  ...
  Future<Map<String, String>> _fetchLessonData() async {
    ...
    try {
      final doc = await _firestore.collection('programcontent').doc('Bachelor of Electronics Engineering Technology').get();
      if (doc.exists) {
        lessonData['1'] =
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Card(
                          ...
                          child: ExpansionTile(
                            ...
                            title: index == 0
                                ? const Text('Introduction to BElectroET')
                                : (index == 1
                                ? const Text('Why Choose BElectroET?')
                                : (index == 2
                                ? const Text(
                                'Career Opportunities in BElectroET')
                                : (index == 3
                                ? const Text(
                                'Skills Developed in BElectroET')
                                : const Text('')))),
                            children: [
                              Column(
                                        ...
                                        Padding(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              const Text(
                                                "Top Jobs for BElectroET Graduates:",
                                                style: TextStyle(
                                                  fontSize: 20,
                                                  fontWeight: FontWeight.bold,
                                                ),
