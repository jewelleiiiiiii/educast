...
class AcademicStemScreen extends StatelessWidget {
  const AcademicStemScreen({super.key});
                                      ...
                                      child: Column(
                                        children: [
                                          ...
                                          const Padding(
                                            ...
                                            child: Text(
                                              'STEM is a dynamic and forward-thinking strand that nurtures analytical minds and problem solvers. '
                                                  'By focusing on scientific inquiry, technological innovation, engineering design, and mathematical '
                                                  'reasoning, students are equipped to tackle real-world challenges and contribute to advancements in science and technology.',
                                              style: TextStyle(
                                                fontSize: 14,
